...
<table id="t" width="100%"  border="0" cellpadding="2" cellspacing="1" bgcolor="#CCEEFF" align="center" style="margin-top:8px">
		...
		<tr align="center"><td><br></td></tr>
		<tr align="center"><td>联系电话：<input width="50" id="Ttel" type="text"  value="${teacher.ttel }" name="telephone" onblur="check(this)"></td></tr>
		<tr align="center"><td><br></td></tr>
		<tr align="center"><td>专业：<input width="50" id="Tmajor" type="text"   value="${teacher.tmajor }"></td></tr>
		<tr align="center"><td><br></td></tr>
