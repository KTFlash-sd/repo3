...
<a href="work/work.jsp"><input type="button" value="返回"></a><br><br><br><br>
		...
		<tr align="center" >
		<td>周期：</td><td>
		<input type="number" name="wtime"  required>（周）
		</td></tr><tr height="20px"></tr>
		<tr align="center" ><td colspan="2" >
		<input type="button" name="but" value="提交">&nbsp<a href="work/work.jsp"><input type="button" value="返回"></a>
		</td></tr>
</table>
</body>
...
$(function(){
	...
	$("[name=but]").click(function(){
		...
		$.ajax({
			 url:"work",
			 data:{"method":"addWork" ,"Wid":wid,"Cid":cid,"Lid":lid,"Tid":tid,"Wstart":start+wstart,"Wend":start+wend,"Wtime":time},
