...
<tr  align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><input  name="aid"  type="checkbox"  id="id"  value="${account.aid }"  class="np"></td>
	 
	    <td width="18%">${account.aid }</td>
	    <td width="18%">${account.username }</td>
	    <td width="18%">${account.role.rname }</td>
	    <td width="18%">${account.astate==0?"未启用":(account.astate==1?"已启用":"已废弃") }</td>

	<td>
	<a href="${pageContext.request.contextPath }/account.do?method=delete&aid=${account.aid }&thispage=${pagebean.thispage }" onclick="return confirm('确认删除吗？')">删除</a> | 
	<a href="${pageContext.request.contextPath }/account.do?method=select&aid=${account.aid }">编辑</a> 
	</td>
</tr>
...
<tr align="right" bgcolor="#EEF4EA" class="kk">
	<td height="36" colspan="6" align="center">
	 ...
	 <a href="${pageContext.request.contextPath }/account.do?method=query&thispage=1">[首页]</a> 
	 ...
	 <a href="${pageContext.request.contextPath }/account.do?method=query&thispage=${pagebean.getTotalpage()}">[末页]</a>
    </td>
</tr>
</table>
</form> 
