	...
	<form name="form2">
		...
		<table id="t" width="98%" border="1" cellpadding="2" cellspacing="1"
			...
			<tr align="center">
				...
				<td colspan="2"><a
					href="${pageContext.request.contextPath }/gradeservlet?method=querypage1&thispage=1">【首页】</a>
					<a
					href="${pageContext.request.contextPath }/gradeservlet?method=querypage1&thispage=${pagebean.thispage-1}">【上一页】</a>
					<a
					href="${pageContext.request.contextPath }/gradeservlet?method=querypage1&thispage=${pagebean.thispage+1}">【下一页】</a>
					<a
					href="${pageContext.request.contextPath }/gradeservlet?method=querypage1&thispage=${pagebean.totalpage }">【末页】</a></td>
			</tr>
		</table>
	</form>
</body>
