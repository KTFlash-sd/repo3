...
<body>
<a href="student/shenhe.jsp"><input type="button" value="返回"></a><br><br><br><br>
		...
		<tr align="center"><td><br></td></tr>
		<tr align="center"><td>邮箱：<input width="50" name="Sem" type="email" value="${student.sem }"  disabled></td></tr>
		<tr align="center"><td><br></td></tr>
